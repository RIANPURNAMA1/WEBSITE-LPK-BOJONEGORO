      ...
      >
        ...
        >
          <span className="text-[10px] md:text-xs font-bold bg-[#007ab3] rounded-full text-white px-3 md:px-4 py-1 md:py-1.5 mr-2 md:mr-3 flex items-center gap-1 whitespace-nowrap">
            <Sparkles className="w-2.5 h-2.5 md:w-3 md:h-3" /> {t("hero.badgeDaftar")}
          </span>
          <span className="text-xs md:text-sm font-medium whitespace-nowrap">{t("hero.badgeMulai")}</span>
        ...
        >
          ...
          <span className="text-[#007ab3]">{t("hero.heading2")}</span>
        </motion.h1>
        <motion.p
          variants={fadeUp}
